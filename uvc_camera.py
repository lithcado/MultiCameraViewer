...
fps_list = [30, 60]
format = [cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), cv2.VideoWriter_fourcc('Y', 'U', 'Y', '2'),cv2.VideoWriter_fourcc('J', 'P', 'E', 'G')]
...
class UvcCamera(QtCore.QObject):
    ...
    def camera_init(self, cam_name):
        ...
        if not self.cap.isOpened():
            ...
            print("Camera " + str(self.cam_name) + " open finish!")
...
if __name__ == '__main__':
    cam1 = UvcCamera()
    cam1.camera_init(0)
    print(cam1.cap.set(cv2.CAP_PROP_FOURCC, cv2.VideoWriter_fourcc('M', 'J', 'P', 'G')))
