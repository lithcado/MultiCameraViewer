...
class CameraView:
    ...
    def camera_parameter_set(self, qwidth , qheight , qframe_rate):
        flag1 = self.cap.set(cv2.CAP_PROP_FRAME_WIDTH, qwidth)
        flag2 = self.cap.set(cv2.CAP_PROP_FRAME_HEIGHT, qheight)
        flag3 = self.cap.set(cv2.CAP_PROP_FPS, qframe_rate)
