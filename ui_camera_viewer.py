...
class Ui_Widget(object):
    def setupUi(self, Form):
        ...
        self.format_list.addItem("")
        self.image_window = QtWidgets.QLabel(Form)
        ...
        self.btn_close_camera = QtWidgets.QPushButton(Form)
        ...
        self.btn_counterclockwise_90 = QtWidgets.QPushButton(Form)
